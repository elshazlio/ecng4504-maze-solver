...
const unsigned long PROBE_STRAIGHT_MS     = 100;

const unsigned long DEAD_END_PROBE_MS     = 170;
...
void processCommand(char *cmd)
{
  ...
  if (strcmp(cmd, "RESUME_TRAIN") == 0) {
    logLine("CMD=RESUME_TRAIN");
    logLine("RESUME_TRAIN_IGNORED_NO_CHECKPOINT");
    return;
  }
...
void setup()
{
  ...
  logLine("Bluetooth commands: TRAIN, START, STATUS, PATH, DUMP, LOAD, CLEAR, STOP, PAUSE, RESUME, RESUME_TRAIN");
